...
## Using numeric vector data and image data generated by an IFCB (Imaging FlowCytobot) to train a species-level classifier of phytoplankton in the North Atlantic
